document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    setTimeout(() => {
      ...
      showSuccessMessage('¡Página web generada con éxito!');
      
      submitBtn.textContent = 'Generar mi página web';
  ...
  function addSocialField(socialType) {
    ...
    document.querySelector(`[data-field="${fieldId}"]`).addEventListener('click', function() {
      ...
      document.querySelector(`.social-option[data-social="${socialType}"]`).classList.remove('added');
    });
  }
